...
class SimpleImage {
  ...
  public function extractColors($count = 5, $backgroundColor = null) {
      ...
      $new_home = str_replace('/claviska','',$homepath);
      require($new_home.'/League/ColorExtractor/Color.php');
      require($new_home.'/League/ColorExtractor/Palette.php');
      require($new_home.'/League/ColorExtractor/ColorExtractor.php');
