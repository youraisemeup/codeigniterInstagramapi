...
//            return Common::error(__("Missing meta data"));
            ...
            $Common = new Common();
            return $Common->error("Missing meta data");
        }
...
//                return Common::error(__("Invalid meta data"));
                ...
                $Common = new Common();
                return $Common->error("Invalid meta data");
                break;
        }
...
//            return Common::error(__("Couldn't get the file"));
            ...
            $Common = new Common();
            return $Common->error("Couldn't get the file");
        }
...
//            return Common::error(__("Couldn't find the image!"));
            ...
            $Common = new Common();
            return $Common->error("Couldn't find the image!");
        }
...
//            return Common::error(__("Couldn't get file type!"));
            ...
            $Common = new Common();
            return $Common->error("Couldn't get file type!");
        }
