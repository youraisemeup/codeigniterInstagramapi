...
class Moment extends \DateTime
{
    ...
    public function __construct($dateTime = 'now', $timezone = null, $immutableMode = false)
    {
        ...
        require_once(__DIR__ . '/MomentLocale.php');
//        require_once(__DIR__ . '/FormatsInterface.php');
////        require_once(__DIR__ . '/Moment.php');
//        require_once(__DIR__ . '/MomentException.php');
//        require_once(__DIR__ . '/MomentFromVo.php');
//        require_once(__DIR__ . '/MomentHelper.php');
//        require_once(__DIR__ . '/MomentPeriodVo.php');
        // set moment
