...
class FFmpeg
{
        ...
        $command)
    {
        ...
        $new_home = str_replace('mgp25/instagram-php/src/Media/Video','',$homepath);


        require($new_home.'symfony/process/Process.php');
//        require($new_home.'autoload.php');

//        if(file_exists($new_home.'symfony/process/Process.php')){
//            echo sprintf('file %s exists',$new_home.'symfony/process/Process.php');
//        }else{
//            echo sprintf('file %s does not exist',$new_home.'symfony/process/Process.php');
//        }
//        die();
