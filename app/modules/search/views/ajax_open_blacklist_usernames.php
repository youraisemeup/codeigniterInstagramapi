    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="profile">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <textarea rows="4" class="form-control no-resize popup_list_tags" placeholder="<?=l('Usernames')?>"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn new-blue waves-effect btnAddBlacklistUsernames" style="display: none;text-transform: none !important;"><?=l('Add Usernames')?></button>
