                ...
                <div class="header">
                    <div class="form-inline">
                        <div class="btn-group" role="group">
                            ...
                            <a href="<?=cn('update')?>" style="padding: 6px 20px;font-size: 16px !important;text-align: center;width: 55% !important;" class="btn bg-light-green waves-effect"><i class="fa fa-plus" aria-hidden="true"></i> <?=l('Add new')?></a>
                        </div>
                    </div>
                </div>
                <div class="body p0">
